## Hi there, I'm <a href="https://www.linkedin.com/abdelrahman-emam">Abdelrahman Emam</a> :wave:
...
I am a Data Analyst and AI both **`Machine learning`** & **`Deep learning`** passionate Engineer. I love programming, and I've been studying and doing projects on these topics for **`over 2 years now`**.
...
- :books: For over **`2 years`** I've never stopped learning more about AI, that's why I continuously enchance my skills while learning/applying about:
  ...
  - **Deep Learning (Theory/Practice):**
    ...
    - **Computer vision** (Classic / state-of-the-art) approaches using [**`OpenCV`**, **`PIL`**, **`Convlutional Neural Networks (CNNs)`**]
